                ...
                <div class="row py-2">
                    ...
                    <div class="col-12 justify-content-center  col-md-7 enlaces d-flex text-end justify-content-md-end pe-md-5">
                        <div class="menu-enlaces d-flex align-items-center">
                            <a href="#" class="px-4  d-flex align-items-center text-center" >
                                <span>Turismo</span>
                            </a>
                        </div> 

                        <div class="menu-enlaces d-flex align-items-center">
                        <a href="/AppTurismoP/VistaArriendoNoS.jsp"  class="px-4  d-flex align-items-center text-center">
                            <span>Arriendos</span>
                        </a>
                        </div>

                       <div class="d-flex flex-row align-items-center">
                           <a href="/AppTurismoP/Login.jsp"class="btn-perfil">
