...
<head>
    ...
    <body > 
        ...
        <!-- Cabezera -->
        <section>
           <div class="row contenedor-cabecera d-flex justify-content-center mb-4 g-0"> 
               <div class="col-4 d-flex align-items-center justify-content-center">
                   <h2>Departamentos en todo Chile</h2>
               </div>
               <div class="col-4  d-flex align-items-center justify-content-center">
        ...
        <section>
            ...
            <div class="row d-flex justify-content-center m-4 ">
                <div class="col-6 d-flex align-items-center ficha-departamento" id="ficha-departamento">  
                    <a href="ControladorVistaCliente?accion=ServicioTour" method="POST" id="link"></a>
                    <div class="col-3 p-1">
                        <img src="Css/img/vinna_del_mar_servicio.jpg" class=" imagen-departamento w-100" alt=""/>
                        
                    </div>
                    <div class="col-9 ms-2 p-1 d-block ">
                        <div class="col-12 mb-3">
                            <p>Viña del mar y valparaiso</p>
                            <h3>Tour borde costero</h3>
                            <span>Viña del mar y valparaiso</span>
                        </div> 
                        <div class=" col-12 d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-6 d-flex align-items-center justify-content-end">
                                <a href="#" class=" btn-departamento btn  px-3 py-2 ">
                                    <span class="texto-precio">$24.000xPersona</span>
                                </a>
