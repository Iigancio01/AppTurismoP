                ...
                <div  class="card">
                    <div  class="card-header">
                      ...
                      <div  class="card-block">
                        <a class="btn btn-success" href="ControladorMantencion?accion=listarDepMantencion" target="ContenedorPrincipal">Departamentos en mantencion</a>
                    </div>                 
                            ...
                            <table id="dom-table" class="table table-striped table-bordered nowrap">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-warning" href="ControladorMantencion?accion=AgregarMantenimiento&IdDepartamento=<%=dpto.getIdDepartamento()%>" target="ContenedorPrincipal">Agregar Mantencion</a>
                                    </td>
                                </tr>
                                <%}%>
                                </tbody>
