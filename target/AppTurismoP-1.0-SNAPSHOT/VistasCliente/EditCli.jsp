    ...
    <body>
         <div class="container">
            ...
            <form action="ControladorCliente">
                ...
                Id Comuna:<br>
                  <select data-live-search="true"  class="selectpicker" name="txtIdComuna" required value="<%= cli.getIdComuna() %>">
                    <option value="<%= cli.getIdComuna() %>"> <%= cli.getnombre_com() %></option>
                ...
                Estado:<br>
                <select class="form-control" type="text" name="txtEstado" value="<%= cli.getestado() %>">
                <option value="<%= cli.getestado() %>"> <%=est%></option>
