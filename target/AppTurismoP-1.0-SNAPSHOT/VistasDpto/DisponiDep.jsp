        ...
        <div style="height:100%; width:100%" class="col-sm-12" >
                <div  class="card">
                    <div  class="card-header">
                        <h5>Departamentos no disponibles</h5>
                    </div>
                      <div  class="card-block">
                        <a class="btn btn-success" href="ControladorEstadoDpto?accion=listarDepDispo" target="ContenedorPrincipal">Departamentos disponibles</a>
                    </div>                 
                        ...
                        <div  class="dt-responsive table-responsive">
                            <table id="dom-table" class="table table-striped table-bordered nowrap">
                                ...
                                <%
                                    ...
                                    List<Departamentos>list=dao.listarDptoNoDispo();
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><%= dpto.getIdTarifa()%></td>
                                    <td class="text-center"><%= dpto.getIdComuna()%></td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-success" href="ControladorEstadoDpto?accion=cambiarEstadoD&IdDepartamento=<%=dpto.getIdDepartamento()%>" onclick="return confirm('¿Seguro que quieres cambiar el estado de este departamento a disponible?')" >Cambiar Disponibilidad</a>
                                    </td>
                                </tr>
                                <%}%>
                                </tbody>
