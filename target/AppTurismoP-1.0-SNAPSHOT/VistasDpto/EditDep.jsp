    ...
    <body>
         <div class="container">
            ...
            <form action="ControladorDpto">
                ...
                Tarifa:<br>
                <select class="form-control" type="text" name="txtTarifa" value="<%= dpto.getIdTarifa() %>">
                <option value="<%= dpto.getIdTarifa() %>"> <%= dpto.gettarifa() %></option>
                 <option value="1"> 12</option>
                 <option value="2"> 1000000</option>
                </select>
                Comuna:<br>
                <select data-live-search="true"  class="selectpicker" name="txtcomuna" required value="<%= dpto.getIdComuna() %>">
                    <option value="<%= dpto.getIdComuna() %>"> <%= dpto.getnombre_com() %></option>
