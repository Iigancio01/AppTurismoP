                ...
                <div  class="card">
                    <div  class="card-header">
                      ...
                      <div  class="card-block">
                        <a class="btn btn-success" href="ControladorArriendo?accion=ListarArriendosEdit" target="ContenedorPrincipal">Editar Arriendos</a>
                    </div>                 
                            ...
                            <table id="dom-table" class="table table-striped table-bordered nowrap">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-warning" href="ControladorPdfCheckin?IdArriendo=<%=arri.getIdArriendo()%>" target="ContenedorPrincipal">Check in</a>
                                        <a class="btn btn-danger" href="ControladorServicios?accion=eliminarServicio&IdSubFamiliaServicio=<%=arri.getIdArriendo()%>" onclick="return confirm('¿Seguro que quieres eliminar?')" >Check out</a>
                                    </td>
                                </tr>
                                <%}%>
                                </tbody>
